...
import com.hb.skills.Fake;
import com.hb.skills.MageHealthSteal;
import com.hb.skills.MageLightning;
...
public class Mage extends Player{
	...
	public Mage(double x, double y, int width, int height, Id id,String networkId, Handler handler,String username) {
		super(x, y, width, height, id,networkId, handler,username);
	
		/*Minden karakternek tudnia kell magáról azt az enum értéket, hogy õ milyen típusú karakter.*/
		...
		this.skillIcons = ImageAssets.mageskillimages;
		
		skills[0] = new MageLightning(this);/*Lightning*/
		skills[1] = new MageHealthSteal(this);/**/
		skills[2] = new Fake(this);/**/
		skills[3] = new Fake(this);/**/
		skills[4] = new Fake(this);/**/
		skills[5] = new Fake(this);/**/
		skills[6] = new Fake(this);/**/
	...
	public void updateServer(){
		...
		if(true){
			...
			try{
					...
					/*Minden karakter felküldi, hogy õ melyik karaktert jelöli ki éppen, ezálltal tud a 
					 mások gépén is kijelölve támadni.*/
	...
	public void setHealth(int health) {
		...
		/*Itt az történik, hogy leellenõrzöm, hogy ha az életerõmódosítás több lenne mint a karakter maximum
		 életereje, akkor ne menjen ki a svából, csak a maxéleterõre állítjuk be.*/
