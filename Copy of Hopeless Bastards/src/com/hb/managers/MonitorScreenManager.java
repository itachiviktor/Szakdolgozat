...
public class MonitorScreenManager {
	...
	public void render(Graphics g){
		...
		if(skill0useable){
			g.drawImage(player.skillIcons[0].getBufferedImage(),skill0.x,skill0.y,skill0.width,skill0.height,null);
		}else{
		...
		if(skill1useable){
			g.drawImage(player.skillIcons[1].getBufferedImage(),skill1.x,skill1.y,skill1.width,skill1.height,null);
		}else{
			g.drawImage(player.skillIcons[1].getBufferedImage(),skill1.x,skill1.y,skill1.width,skill1.height,null);
		...
		if(skill2useable){
			g.drawImage(player.skillIcons[2].getBufferedImage(),skill2.x,skill2.y,skill2.width,skill2.height,null);
		}else{
			g.drawImage(player.skillIcons[2].getBufferedImage(),skill2.x,skill2.y,skill2.width,skill2.height,null);
		...
		if(skill3useable){
			g.drawImage(player.skillIcons[3].getBufferedImage(),skill3.x,skill3.y,skill3.width,skill3.height,null);
		}else{
			g.drawImage(player.skillIcons[3].getBufferedImage(),skill3.x,skill3.y,skill3.width,skill3.height,null);
		...
		if(skill4useable){
			g.drawImage(player.skillIcons[4].getBufferedImage(),skill4.x,skill4.y,skill4.width,skill4.height,null);
		}else{
			g.drawImage(player.skillIcons[4].getBufferedImage(),skill4.x,skill4.y,skill4.width,skill4.height,null);
		...
		if(skill5useable){
			g.drawImage(player.skillIcons[5].getBufferedImage(),skill5.x,skill5.y,skill5.width,skill5.height,null);
		}else{
			g.drawImage(player.skillIcons[5].getBufferedImage(),skill5.x,skill5.y,skill5.width,skill5.height,null);
		...
		if(skill6useable){
			g.drawImage(player.skillIcons[6].getBufferedImage(),skill6.x,skill6.y,skill6.width,skill6.height,null);
		}else{
			g.drawImage(player.skillIcons[6].getBufferedImage(),skill6.x,skill6.y,skill6.width,skill6.height,null);
