...
public class Handler extends GameState {
	...
	/*Ki lehet jelölni karaktert vagy entitást, és bizonyos képességek csak úgy mûködnek, hogyha ki van jelölve */
	public Player selectedPlayer = null;
	
	
	
	public Handler(Game gsm,CharacterType characterType) {
		super(gsm);
	...
	public void render(Graphics g){
		...
		if(player != null){
			if(player.selectedPlayer == null){
		    	g.drawString("NULL", (int)player.x + 100, (int)player.y + 100);
		    }else{
		    	g.drawString(player.selectedPlayer.username, (int)player.x + 100, (int)player.y + 100);
		    }
		}
			...
			public void call(Object... arg0) {
				...
				try{
					...
					/*Amikor létrehozzuk a kapcsolatot a szerverrel, akkor az ad nekünk egy egyéni azonosítót,
					 és kiváltja ezta s ocketid eseményt, amire ez a metódus hívódik meg.Mivel regisztráljuk magunkat
					 ...
					 a saját kliensében.*/
					if(Handler.this.characterType == CharacterType.MAGE){
					...
					}else if(Handler.this.characterType == CharacterType.MUSCLEMAN){
