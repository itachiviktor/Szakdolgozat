...
public class ImageAssets {
	...
	public static Sprite[] mageskillimages = new Sprite[7];
	...
	public static BufferedImage warningWindow;
	...
	private void init(){
		...
		for(int i=0;i<7;i++){
			mageskillimages[i] = new Sprite(skillimages52x52px, i+1, 2, 52, 52);
		}
		...
		try {
			...
			warningWindow = ImageIO.read(getClass().getResource("/warning.png"));
