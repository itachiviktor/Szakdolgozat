...
import com.hb.skills.Bullet;
import com.hb.skills.MusclemanBuff;
import com.hb.skills.MusclemanDoubleShot;
import com.hb.skills.MusclemanExplosion;
import com.hb.skills.MusclemanJumpingBack;
import com.hb.skills.MusclemanOneShot;
import com.hb.skills.MusclemanSpeedRise;
import com.hb.skills.MusclemanTrap;
...
public class Muscleman extends Player{
	...
	public Muscleman(double x, double y, int width, int height, Id id,String networkId, Handler handler,String username) {
		super(x, y, width, height, id,networkId, handler,username);
	
		this.characterType = CharacterType.MUSCLEMAN;
		angle = 0;
		this.health = 2000;
		this.maxHealth = 2000;
		...
		this.skillIcons = ImageAssets.musclemanskillimages;
		
		skills[0] = new MusclemanTrap(this);/*trap*/
		skills[1] = new MusclemanBuff(this);/*buff*/
		skills[2] = new MusclemanJumpingBack(this);/*jump back*/
		skills[3] = new MusclemanSpeedRise(this);/*speed rise*/
		skills[4] = new MusclemanOneShot(this);/*oseshot*/
		skills[5] = new MusclemanDoubleShot(this);/*doubleshot*/
		skills[6] = new MusclemanExplosion(this);/*explosion*/
	...
	public void tick(){
		...
		if(getBounds().contains(handler.mouse)){
			heldover = true;
			if(handler.leftClick){
				handler.player.selectedPlayer = this;
			}
		}else{
			heldover = false;
		}
	...
	public void render(Graphics g){
	    ...
	    if(live){
		    ...
		    if(up == false && down == false && left == false && right == false){
		    	g.drawImage(ImageAssets.muscleman[3].getBufferedImage(), (int)x, (int)y, 63,63,null);
		    }else{
	...
	public void updateServer(){
		...
		if(true){
			...
			try{
					...
					data.put("characterType", this.characterType.toString());
					if(this.selectedPlayer != null){
						data.put("selectedPlayer", this.selectedPlayer.networkId);
					}else{
